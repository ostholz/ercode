...
class WallpaperController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        qrButton.addTarget(self, action: "addQRImage", forControlEvents: UIControlEvents.TouchUpInside)
        /*
...
//        let qrImage = UIImage(named: "qr_code.jpg")
      ...
      if (qrImage == nil) {
        ...
        qrImageView.frame = CGRect(x: 0, y: 0, width: 100, height: 100)
    ...
    func imagePickerController(picker: UIImagePickerController!, didFinishPickingMediaWithInfo info: NSDictionary! ) {
        ...
        backgroundImageview!.frame = CGRectMake(0, 0, screenSize.width, screenSize.width * imageSize.height / imageSize.width)
